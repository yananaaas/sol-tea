...
### Пріоритет 4 — Мануальне тестування (окремий чат)
...
### Пріоритет 7 — Код і архітектура — адмінка (окремий чат)
- **Code review адмінки** — окреме ревʼю після готової sol-admin.html

### Пріоритет 8 — Медіа (окремий чат)
...
### Пріоритет 9 — База даних (окремий чат)
