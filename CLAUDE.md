...
- **Всі компоненти DS → сторінки** — перевірити і прив'язати всі компоненти дизайн-системи до відповідних сторінок (не тільки Хедер): кнопки, пагінація, counter, картки товарів, акордеон, бейджі, пілюлі, футер, профіль-панель тощо. Відповідність класів і стилів між DS і живими сторінками.
...
### Пріоритет 4 — Адмін-панель (окремий чат)
...
### Пріоритет 6 — База даних (окремий чат)
...
### Пріоритет 7 — Код і архітектура (окремий чат)
- **Code review** — після того як усі сторінки готові
- **Email підписка** — повідомлення після сабміту у футері

### Пріоритет 8 — Тестування і кейс (окремий чат)
