...
3. **Відстані між картками** — перевірити та підправити всі gap-и (повітряно та однаково)
4. **Scroll-to-top на sol-shop.html** — стрілка не фіксується як на головній — виправити
5. **FAQ у хедері** — розділ Запитання → чат з підтримкою
6. **Навігація** — Логотип → головна; "Про нас" — вимкнути як навлінк (або окрема сторінка)
7. **Блоки фото+текст на головній** — вирівняти контейнери 1:1
8. **Кнопка "Всі товари" в Хітах продажів** → `href="sol-shop.html"`
