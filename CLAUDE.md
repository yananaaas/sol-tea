...
| `sol-design-system.html` | 🔲 Планується | Документація дизайн системи з живими прикладами |
...
### Простіші — можна в поточному або наступному чаті
- **Max-width cap** — обмежити сайт шириною 1440px (MacBook Air), на ширших екранах фон `--cream` по боках. Застосувати до всіх сторінок.
- **Нормалізувати логотипи** — відкрити PNG доставки/оплат у Figma, обрізати до контенту, експортувати з однаковим відступом (10% з кожної сторони, 100×100px).

### Складніші — окремий чат
- **sol-about.html** — окрема сторінка "Про нас". Не дублює Головну. Розповідає іншу історію: команда, цінності, процес відбору чаю, джерела. Той самий стиль, editorial, мінімалістично.
- **sol-design-system.html** — сторінка-документація дизайн системи: палітра, типографіка, кнопки, інпути, пілюлі, іконки, картки — з живими прикладами і CSS-класами. В стилі сайту, як окрема сторінка.
- **Чистота коду** — пройтись по всіх файлах: дублі CSS, мертві правила, консистентність між сторінками.
- **Wishlist панель** — slide-in як профіль, з іконкою серця в nav.

### Коли будуть зображення
- **Головна сторінка** — візуальні доопрацювання після підключення реальних фото.
- **Підключити `/images/`** — замінити всі placeholder-div на `<img>` теги.
- **Email підписка** — повідомлення після сабміту у футері.

### На потім (архітектура)
- Розглянути додавання реального бекенду: Supabase (база даних) + Formspree/Netlify Forms (форма замовлення). Для портфоліо як Design Engineer.
